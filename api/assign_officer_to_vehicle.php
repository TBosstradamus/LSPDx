<?php
// api/assign_officer_to_vehicle.php
...
if (!$data || !isset($data['officerId']) || !isset($data['vehicleId']) || !isset($data['seatIndex'])) {
...
try {
    ...
    $success = $dispatchModel->assignOfficer(
        $data['officerId'],
        'vehicle',
        $data['vehicleId'],
        $data['seatIndex']
    ...
    if ($success) {
        ...
        echo json_encode(['error' => 'Failed to assign officer.']);
    }
} catch (Exception $e) {
    http_response_code(500);
